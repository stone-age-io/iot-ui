  ...
  <div>
    ...
    <div v-else-if="typeData">
      <div class="flex justify-between items-start mb-6">
        <div>
          <div class="text-sm text-gray-500 mb-1">Edge Region</div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="card lg:col-span-2">
          <h2 class="text-xl font-semibold mb-4">Region Details</h2>
        ...
        <div class="card">
          ...
          <div class="space-y-6">
            ...
            <!-- Edge Usage -->
            <div>
              <div class="text-sm text-gray-500 mb-1">Used by Edges</div>
              <div class="flex items-center">
                <i class="pi pi-server text-blue-600 mr-2"></i>
